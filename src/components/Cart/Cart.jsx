                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <button className="px-2.5 py-1 bg-slate-200 text-slate-600 hover:text-white rounded-lg hover:bg-violet-600 transition-colors duration-300" onClick={() => handleQuantityChange(index, quantities[index] - 1)}
                                                    >
                                                        -
                                                    </button>
                                                    <input type="number" id={`quantity-${item.id}`} value={quantities[index]} min="1"
                                                        onInput={(e) => {
                                                            if (e.target.value === '') {
                                                                e.target.value = 1;
                                                            }
                                                        }} onChange={(e) => handleQuantityChange(index, parseInt(e.target.value))} className="appearance-none text-md w-6 h-9 text-center text-slate-600 font-semibold"
                                                    />
                                                    <button className="px-2.5 py-1 bg-slate-200 text-slate-600 hover:text-white rounded-lg hover:bg-violet-600 transition-colors duration-300" onClick={() => handleQuantityChange(index, quantities[index] + 1)}
                                                    >
                                                        +
